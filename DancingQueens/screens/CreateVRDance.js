...
export default function CreateVRDance({ navigation }) {
          ...
          allPoses.push(
            {
              ...
              filename: "1",
              selected: false,
              uri: require("./assets/poses/RubyPose1.heic"),
            },
            {
              dancer,
              filename: "2",
              selected: false,
              uri: require("./assets/poses/RubyPose2.heic"),
            },
            {
              dancer,
              filename: "3",
              selected: false,
              uri: require("./assets/poses/RubyPose3.heic"),
            },
            {
              dancer,
              filename: "4",
              selected: false,
              uri: require("./assets/poses/RubyPose4.heic"),
            },
            {
              dancer,
              filename: "5",
              selected: false,
              uri: require("./assets/poses/RubyPose5.heic"),
            },
            {
              dancer,
              filename: "6",
              selected: false,
              uri: require("./assets/poses/RubyPose6.heic"),
            },
            {
              dancer,
              filename: "7",
              selected: false,
              uri: require("./assets/poses/RubyPose7.heic"),
            }
          );
          ...
          allPoses.push(
            {
              ...
              filename: "1",
              selected: false,
              uri: require("./assets/poses/YentaPose1.heic"),
            },
            {
              dancer,
              filename: "2",
              selected: false,
              uri: require("./assets/poses/YentaPose2.heic"),
            },
            {
              dancer,
              filename: "3",
              selected: false,
              uri: require("./assets/poses/YentaPose3.heic"),
            },
            {
              dancer,
              filename: "4",
              selected: false,
              uri: require("./assets/poses/YentaPose4.heic"),
            },
            {
              dancer,
              filename: "5",
              selected: false,
              uri: require("./assets/poses/YentaPose5.heic"),
            },
            {
              dancer,
              filename: "6",
              selected: false,
              uri: require("./assets/poses/YentaPose6.heic"),
            },
            {
              dancer,
              filename: "7",
              selected: false,
              uri: require("./assets/poses/YentaPose7.heic"),
            }
          );
        } else if (dancer === "Sage") {
          allPoses.push(
            {
              ...
              filename: "1",
              selected: false,
              uri: require("./assets/poses/SagePose1.heic"),
            },
            {
              dancer,
              filename: "2",
              selected: false,
              uri: require("./assets/poses/SagePose2.heic"),
            },
            {
              dancer,
              filename: "3",
              selected: false,
              uri: require("./assets/poses/SagePose3.heic"),
            },
            {
              dancer,
              filename: "4",
              selected: false,
              uri: require("./assets/poses/SagePose4.heic"),
            },
            {
              dancer,
              filename: "5",
              selected: false,
              uri: require("./assets/poses/SagePose5.heic"),
            },
            {
              dancer,
              filename: "6",
              selected: false,
              uri: require("./assets/poses/SagePose6.heic"),
            },
            {
              dancer,
              filename: "7",
              selected: false,
              uri: require("./assets/poses/SagePose7.heic"),
            }
          );
        }
      });
  ...
  const togglePose = (selectedPose) => {
    const updatedPoses = poses.map((pose) => {
      if (
        pose.filename === selectedPose.filename &&
        pose.dancer === selectedPose.dancer
      ) {
  ...
  const handleCreateBooking = async () => {
    ...
    try {
      ...
      const response = await fetch(
        "http://localhost:8080/index.php/dances/create",
        {
          method: "POST",
          credentials: "include",
          headers: {
      ...
      try {
        ...
        Alert.alert(
          "Error",
          "Something went wrong while creating the dance."
        );
        return;
      }
      ...
      if (response.ok) {
        ...
        Alert.alert("Error", data.message || "Dance creation failed");
      }
    } catch (error) {
    ...
    <ScrollView contentContainerStyle={styles.scrollContainer}>
      <View style={styles.container}>
        ...
        <Dropdown
          ...
          onChange={(item) => {
            setSelectedDancer(item);
            setDancers([item.value]);
          }}
          inside
        ...
        <Button title="Create Virtual Dance" onPress={handleCreateBooking} />
      </View>
