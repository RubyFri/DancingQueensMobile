...
export default function ModifyBooking({ navigation }) {
  ...
  return (
    <ScrollView contentContainerStyle={styles.scrollContainer}>
      <View style={styles.container}>
        ...
        <Text style={styles.heading1}>MODIFY BOOKING</Text>
